(Brit = function(){
  ...
  Brit.prototype.randomPhrases = [
    ...
    "Make sure you transfer the bridge loan to my checking account in this fiscal year.",
    "The tow truck got stuck on the median strip.",
    "Would you like French fries or chips?",
    "Let's hit the bar at the truck stop while they retread the tires.",
    "Turn the Allen wrench counterclockwise.",
    "Would you like zucchini, rutabaga, or beets?",
    "Will you be having coffee with cream?",
    "He's a lawyer, so of course he's got a skeleton in the closet.",
    "Will you bring your fanny pack on vacation?",
    "He cut himself with a switchblade so we rushed him to the emergency room.",
    "There's a popsicle stuck in the elevator door.",
    "If you drive the sedan, please avoid the traffic circle.",
    "I saw it on that billboard right before the overpass!"
    ]
